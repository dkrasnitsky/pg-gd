...
import TemplateEventSimulator from "./TemplateEventSimulator";
  ...
  return (
    <div className="tools-page" style={{height:"100%",background:BG,overflow:"hidden",display:"flex",flexDirection:"column"}}>
      <div className="tools-feature-header">
        <div><span>PROBABILITY LAB</span><h1>{activeTool==="content"?"Подбор Контента":activeTool==="lootbox"?"Lootbox Simulator":activeTool==="lottery"?"Lottery Simulator":activeTool==="cardroulette"?"Card Roulette":activeTool==="personalevent"?"Personal Event":activeTool==="tradervan"?"Trader Van":activeTool==="templateevent"?"Template Event":"Offer Constructor"}</h1></div>
        <div style={{flex:1}}/>
        {!hideSelector&&<div style={{display:"flex",background:BG,borderRadius:20,padding:3,border:`1px solid ${BRD}`}}>
          {[["content","Подбор Контента"],["offers","Offer Constructor"],["lootbox","Lootbox Sim"],["lottery","Lottery Sim"],["cardroulette","Card Roulette"],["personalevent","Personal Event"],["tradervan","Trader Van"],["templateevent","Template Event"]].map(([k,l])=>(
      ...
      <div style={{flex:1,position:"relative"}}>
        <div style={{position:"absolute",inset:0,overflowY:"auto",padding:"0 24px 24px"}}>
          ...
          <div style={{display:activeTool==="templateevent"?"block":"none",paddingTop:18}}><TemplateEventSimulator/></div>
        </div>
      </div>
    </div>
  );
...
const APP_SECTIONS=[
  ...
  {id:"tools",label:"Инструменты",icon:"tools",builtIn:true,items:[
    {id:"content",label:"Подбор Контента"},{id:"offers",label:"Offer Constructor"},{id:"lootbox",label:"Lootbox Simulator"},{id:"lottery",label:"Lottery Simulator"},{id:"cardroulette",label:"Card Roulette"},{id:"personalevent",label:"Personal Event"},{id:"tradervan",label:"Trader Van"},{id:"templateevent",label:"Template Event"}
  ]},
];

const PAGE_TITLES={tasks:"Мои задачи",events:"График ивентов",notes:"Заметки",content:"Подбор Контента",offers:"Offer Constructor",lootbox:"Lootbox Simulator",lottery:"Lottery Simulator",cardroulette:"Card Roulette",personalevent:"Personal Event",tradervan:"Trader Van",templateevent:"Template Event"};
const PAGE_SECTIONS={tasks:"dashboard",events:"dashboard",notes:"dashboard",content:"tools",offers:"tools",lootbox:"tools",lottery:"tools",cardroulette:"tools",personalevent:"tools",tradervan:"tools",templateevent:"tools"};
