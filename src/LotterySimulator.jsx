...
const smallChestItems=()=>[
  ...
  mkItem("weapon_1","102",1,45,250),
  mkItem("weapon_2","103",1,90,250),
  mkItem("weapon_3","104",1,110,250),
  mkItem("weapon_4","105",2,1160,250),
  mkItem("weapon_5","106",2,1190,250),
  mkItem("weapon_6","107",2,1290,250),
  mkItem("weapon_7","108",2,1320,250),
  mkItem("weapon_8","109",2,1460,250),
  mkItem("weapon_9","110",3,1600,250),
  mkItem("weapon_10","111",3,400,250),
  mkItem("cosmetic","112",1,600,1),
  mkItem("weapon_1","113",3,12,250),
  mkItem("weapon_2","114",3,32,250),
  mkItem("weapon_3","115",3,62,250),
  mkItem("weapon_4","116",3,90,250),
  mkItem("weapon_5","117",3,140,250),
  mkItem("weapon_6","118",3,200,250),
  mkItem("weapon_7","119",3,250,250),
  mkItem("weapon_8","120",3,300,250),
  mkItem("weapon_9","121",5,550,250),
  mkItem("weapon_10","122",7,9000,250),
  mkItem("Gems","123",5,1,0),
];

const mediumChestItems=()=>[
  mkItem("avatar","201",1,400,1),
  mkItem("weapon_1","202",5,45,250),
  mkItem("weapon_2","203",5,90,250),
  mkItem("weapon_3","204",5,110,250),
  mkItem("weapon_4","205",10,1160,250),
  mkItem("weapon_5","206",10,1190,250),
  mkItem("weapon_6","207",10,1290,250),
  mkItem("weapon_7","208",10,1320,250),
  mkItem("weapon_8","209",10,1460,250),
  mkItem("weapon_9","210",10,1600,250),
  mkItem("weapon_10","211",10,1000,250),
  mkItem("cosmetic","212",1,600,1),
  mkItem("weapon_1","213",15,10,250),
  mkItem("weapon_2","214",15,30,250),
  mkItem("weapon_3","215",15,60,250),
  mkItem("weapon_4","216",25,90,250),
  mkItem("weapon_5","217",25,120,250),
  mkItem("weapon_6","218",25,170,250),
  mkItem("weapon_7","219",25,210,250),
  mkItem("weapon_8","220",25,279,250),
  mkItem("weapon_9","221",25,520,250),
  mkItem("weapon_10","222",35,9500,250),
  mkItem("Gems","223",30,1,0),
];

const bigChestItems=()=>[
  mkItem("avatar","301",1,100,1),
  mkItem("weapon_1","302",25,150,250),
  mkItem("weapon_2","303",25,200,250),
  mkItem("weapon_3","304",25,250,250),
  mkItem("weapon_4","305",25,1000,250),
  mkItem("weapon_5","306",25,1200,250),
  mkItem("weapon_6","307",25,1500,250),
  mkItem("weapon_7","308",25,2000,250),
  mkItem("weapon_8","309",25,2500,250),
  mkItem("weapon_9","310",25,3000,250),
  mkItem("weapon_10","311",25,50,250),
  mkItem("cosmetic","312",1,150,1),
  mkItem("weapon_1","313",50,35,250),
  mkItem("weapon_2","314",50,45,250),
  mkItem("weapon_3","315",50,55,250),
  mkItem("weapon_4","316",50,100,250),
  mkItem("weapon_5","317",50,110,250),
  mkItem("weapon_6","318",50,200,250),
  mkItem("weapon_7","319",50,300,250),
  mkItem("weapon_8","320",50,400,250),
  mkItem("weapon_9","321",50,600,250),
  mkItem("weapon_10","322",50,200,250),
  mkItem("cosmetic","323",1,100,1),
  mkItem("weapon_1","324",75,10,250),
  mkItem("weapon_2","325",75,15,250),
  mkItem("weapon_3","326",75,20,250),
  mkItem("weapon_4","327",75,35,250),
  mkItem("weapon_5","328",75,55,250),
  mkItem("weapon_6","329",75,75,250),
  mkItem("weapon_7","330",75,100,250),
  mkItem("weapon_8","331",75,140,250),
  mkItem("weapon_9","332",75,160,250),
  mkItem("weapon_10","333",100,16000,250),
  mkItem("Gems","334",150,1,0),
];

const superChestItems=()=>[
  mkItem("weapon_1","401",1,1000,1),
  mkItem("weapon_2","402",1,1000,1),
  mkItem("weapon_3","403",1,1000,1),
  mkItem("weapon_4","404",1,1000,1),
  mkItem("weapon_5","405",1,1000,1),
  mkItem("weapon_6","406",1,1000,1),
  mkItem("weapon_7","407",1,1000,1),
  mkItem("weapon_8","408",1,1000,1),
  mkItem("weapon_9","409",1,1000,1),
  mkItem("weapon_10","410",1,1000,1),
